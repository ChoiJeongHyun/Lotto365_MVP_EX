package kr.co.factoryx.lotto365.commonset.components

import android.content.Context
import androidx.multidex.MultiDex
import androidx.multidex.MultiDexApplication
import kr.co.factoryx.lotto365.miniframework.database.dbmanager.LTDBManager
import kr.co.factoryx.lotto365_mvp.MiniFrameWork.Manager.FontManager

class LottoApplication : MultiDexApplication() {
    ...
    private fun setDreamMap() {
        ...
        dreamMap["사물"] = ArrayList(
            arrayListOf(
                "똥", "담배", "상복", "의자", "이불", "면허증", "치약", "고무인형", "권총", "동전", "리어카", "소방복", "책상", "청소기", "피아노", "중고차", "축구공", "놀이기구", "카메라", "승용차", "신문지", "자동차", "작업차", "철가방", "셔터문", "잡동사니", "세숫대야", "자동차키", "머플러", "작은트럭", "창문", "펌프카", "양복", "바닥담요", "장롱", "컴퓨터", "유리창", "옷고름", "오토바이", "중곡옷", "검은봉지", "케이블선", "흰옷", "돈", "천원", "가구", "만원", "불", "버스", "벽", "칼", "삽", "사진", "지갑", "조끼", "복숭아씨", "말뚝박기", "일회용기저귀", "호스", "전화", "양말", "나무공예", "디지털카메라", "로또", "택시", "트럭", "껍질", "도끼빗", "스티커", "전기선", "지폐", "칫솔", "볼펜", "보따리", "시줏돈", "짐", "모자", "수도꼭지", "시계", "상", "손목시계", "옷", "토끼풀", "우산"
            )
        )

        dreamMap["음식"] = ArrayList(
            arrayListOf(
                "라면", "안주", "옥수수", "단무지", "제사상", "음식", "양주", "냉면", "음료수", "밥", "아이스크림", "소스", "가지", "수박", "바나나", "돈까스", "국수", "소금", "감자", "고구마"
            )
        )

        dreamMap["동물"] = ArrayList(
            arrayListOf(
                "물고기", "악어", "암컷", "쥐", "악어새끼", "고양이", "검은돼지", "금돼지", "거북이", "원숭이", "구렁이", "거미", "말", "뱀", "개미"
            )
        )

        dreamMap["사람"] = ArrayList(
            arrayListOf(
                "군인", "여자", "아버지", "아가씨", "아들", "부처님", "얼굴", "아저씨", "청년", "경찰", "외할머니", "남편", "이모", "동창", "범인", "아이", "엄마", "남자친구", "성인", "동생", "임신부", "스포츠머리", "여자아이", "아는언니", "바람둥이", "할머니", "선배", "친구", "아주머니", "여자동기", "사촌동생", "아는여자", "연예인", "남자아이", "ROTC", "남동생", "젋은이", "형", "수사관", "회사동료", "스님", "아기", "좀비", "처남", "거인", "남자"
            )
        )

        dreamMap["신체"] = ArrayList(
            arrayListOf(
                "무릎", "어깨", "아랫니", "윗니", "생식기", "단발머리", "이빨", "귀", "손", "발", "나체", "팔", "여드름", "팔뒷꿈치", "목", "가슴", "등", "손목", "입", "덧니", "어금니"
            )
        )

        dreamMap["장소"] = ArrayList(
            arrayListOf(
                "시장", "사우나", "공터", "거북이등산", "식당", "옷가게", "통로", "과수원", "무역회사", "신한은행", "우리집", "놀이공원", "아파트", "밭두렁", "노천극장", "낭떠러지", "마당", "암벽", "방송국", "대형슈퍼", "작은섬", "장례식장", "전시회", "대학교", "지하철", "결혼식", "운동장", "발표회", "좁은골목", "계단", "대전", "숲속", "섬", "초등학교", "터널", "사거리", "교회", "시골길", "지하주차장", "교도소", "돌다리", "방", "무대", "고향집", "집", "가게", "길가", "화장실"
            )
        )

        dreamMap["행동"] = ArrayList(
            arrayListOf(
                "물다", "매매", "정리", "혼인서약", "놀람", "대입시험", "교통사고", "애무", "싸움", "머리감기", "목욕", "신체검사", "취직", "빨래", "축구", "잠", "전화통화", "성폭행", "짝짓기", "이사", "인사", "찌름", "위협", "화장", "고개끄덕", "분노", "승리", "키스", "납치", "낚시"
            )
        )

        dreamMap["기타"] = ArrayList(
            arrayListOf(
                "깨짐", "실종", "왼쪽", "붉은갈색", "인상", "외상값", "표범문신", "공양", "결론", "종양", "곰팡이", "허공", "발자국", "꿈", "미소", "돼지코", "영화", "누런", "복", "죽음", "초록", "피", "젖", "커브", "코너", "때", "단서", "소변", "수컷", "전기", "주황색"
            )
        )
