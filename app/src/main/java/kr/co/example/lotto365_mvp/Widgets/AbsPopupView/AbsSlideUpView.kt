...
abstract class AbsSlideUpView(private val context: Context) : PopupView, View.OnClickListener {
    ...
    fun show(duration: Long, interpolator: TimeInterpolator) {
        ...
        val animator = ObjectAnimator.ofFloat(contentView, "y", Utils.getScreenHeight(context) / 1.0f, 0.0f)
    ...
    fun dimiss(duration: Long) {
        ...
        val animator = ObjectAnimator.ofFloat(contentView, "y", 0.0f, Utils.getScreenHeight(context) / 1.0f)
        animator.apply {
